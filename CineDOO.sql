...
CREATE TABLE IF NOT EXISTS `peliculas` (
  ...
  CONSTRAINT fk_peliculas_categorias FOREIGN KEY (`IdCategoria`) REFERENCES `categorias` (`IdCategoria`)
...
CREATE TABLE IF NOT EXISTS `funciones` (
  ...
  CONSTRAINT fk_funciones_peliculas FOREIGN KEY (`IdPelicula`) REFERENCES `peliculas` (`IdPelicula`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_funciones_horarios FOREIGN KEY (`IdHorario`) REFERENCES `horarios` (`IdHorario`)
    ON DELETE CASCADE ON UPDATE CASCADE,
...
CREATE TABLE IF NOT EXISTS `ventas` (
  ...
  CONSTRAINT fk_ventas_usuarios FOREIGN KEY (`IdUsuario`) REFERENCES `usuarios` (`IdUsuario`)
    ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT fk_ventas_funciones FOREIGN KEY (`IdFuncion`) REFERENCES `funciones` (`IdFuncion`)
    ON DELETE CASCADE ON UPDATE CASCADE
